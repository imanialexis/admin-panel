...
#     Course.create(name: 'Gourmet & Short Courses
#         ', description: 'For beginners, gourmet enthusiasts or those wanting to be the best house party host, a wide range of courses have been designed to satisfy the time and budget conscious. ', total_class_hours: 200)
...
#     Course.create(name: 'Pastry & Confectionery', description: 'Discover the art of Pâtisserie. Courses range from specialized ateliers, basic through advanced levels of pastry and confectionary craft making, plated and boutique style desserts, world delicacies and precise decorating techniques.', total_class_hours: 400)
    ...
    # Instructor.create(fname: 'Gordon', lname:'Ramsey', email: 'gramsey@lecordonnoir.com', password:'123', age: 52, salary: 125000, highest_edu: 'MS', cohort_id: 1, is_admin: false)

    # Instructor.create(fname: 'Janice', lname:'Wong', email: 'jwong@lecordonnoir.com', password:'123', age: 37, salary: 128000, highest_edu: 'MS', cohort_id: 2, is_admin: false)

    # Instructor.create(fname: 'Roble', lname:'Ali', email: 'rali@lecordonnoir.com', password:'123' ,age: 32, salary: 132000, highest_edu: 'MS', cohort_id: 3, is_admin: false)
